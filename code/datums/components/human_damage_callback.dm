...
/datum/component/human_damage_callback/Initialize(damage_limit, callback)
...
/datum/component/human_damage_callback/proc/apply_damage(mob/living/carbon/human/H, damage = 0, damagetype = BRUTE, def_zone = null, blocked = 0, sharp = 0, obj/used_weapon = null)
	if(H.stat != DEAD)
