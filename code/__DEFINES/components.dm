...
#define COMSIG_MIDDLE_CLICK_ALT "middle_alt_click"				//from base of atom/MiddleAltClick(): (/mob)
...
// /mob/living signals
#define COMSIG_LIVING_UPDATE_CAN_MOVE "living_update_can_move"			//from base of mob/living/resist() (/mob/living)
