...
/datum/psionic/channel_stage/harvest_thoughts_2/success(mob/living/carbon/psionic, target)
...
/datum/psionic/channel_stage/harvest_thoughts_2/start_channeling(mob/living/carbon/psionic, target)
