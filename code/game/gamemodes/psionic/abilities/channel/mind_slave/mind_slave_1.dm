/datum/psionic/channel_stage/mind_slave/part_1
	duration = 7 SECONDS
	able_to_move = FALSE
...
/datum/psionic/channel_stage/mind_slave/part_1/success(mob/living/carbon/psionic, target)
...
/datum/psionic/channel_stage/mind_slave/part_1/start_channeling(mob/living/carbon/psionic, target)
	if(ishuman(target))
