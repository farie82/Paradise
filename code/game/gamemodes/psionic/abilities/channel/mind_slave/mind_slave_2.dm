/datum/psionic/channel_stage/mind_slave/part_2
	duration = 4 SECONDS

/datum/psionic/channel_stage/mind_slave/part_2/success(mob/living/carbon/psionic, target)
	...
	to_chat(H, "<span class='danger'>You have been enslaved by [psionic]. Follow [psionic.p_their()] every command.</span>")
...
/datum/psionic/channel_stage/mind_slave/part_2/start_channeling(mob/living/carbon/psionic, target)
	if(ishuman(target))
