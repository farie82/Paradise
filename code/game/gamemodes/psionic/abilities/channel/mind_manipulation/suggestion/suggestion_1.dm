/datum/psionic/channel_stage/mind_manipulation/suggestion_1
	duration = 3 SECONDS

/datum/psionic/channel_stage/mind_manipulation/suggestion_1/success(mob/living/carbon/user, target, datum/antagonist/psionic/psionic_datum)
