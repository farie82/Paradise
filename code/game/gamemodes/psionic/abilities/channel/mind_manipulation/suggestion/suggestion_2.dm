/datum/psionic/channel_stage/mind_manipulation/suggestion_2
	duration = 4 SECONDS

/datum/psionic/channel_stage/mind_manipulation/suggestion_2/success(mob/living/carbon/user, target, datum/antagonist/psionic/psionic_datum)
	...
	var/datum/action/psionic/active/targeted/suggestion/ability = psionic_datum.get_active_ability_by_type(/datum/action/psionic/active/targeted/suggestion)
	...
	add_attack_logs(psionic_datum.mind.current, H, "Psionic-suggested")
	...
	to_chat(user, "<span class='warning'>You have successfully implanted the suggestion in [H]'s mind. <i>If [H.p_they()] refuse[H.p_s()] to do as you say just adminhelp.</i></span>")
