...
/datum/psionic/channel_stage/break_mindshield_3/success(mob/living/carbon/psionic, target, datum/psionic/channel/channel_ability)
...
/datum/psionic/channel_stage/break_mindshield_3/start_channeling(mob/living/carbon/psionic, target, datum/psionic/channel/channel_ability)
	if(ishuman(target))
